## Web Scraper for Ballot Intitiatives
## Data Source: https://www.ncsl.org/research/elections-and-campaigns/ballot-measures-database.aspx
## Filtered for Initiatives, All Years, All States, related to Animal Rights/Hunting & Fishing, All Periods
...
html = open("inputs\\initiatives_database.html", encoding="utf8").read()
...
# Cleaning up missing percent yes votes
yes_votes.insert(32, "Unknown")
...
# make csv
df.to_csv("outputs\\initiatives_database.csv", index = False)

# make sql database
connection = sqlite3.connect('initiatives_database')
c = connection.cursor()
...
df.to_sql('initiatives', connection, if_exists='replace', index = False)
connection.commit()
